<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Site_Projeto.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h3 class="auto-style3">&nbsp;Login</h3>
    <p class="auto-style3">&nbsp;</p>

    <p class="auto-style3">
    &nbsp;Utilizador:<asp:TextBox ID="tb_utilizador" runat="server" Width="197px"></asp:TextBox>
</p>
<p class="auto-style3">
    &nbsp;Palavra-passe:<asp:TextBox ID="tb_pw" runat="server" TextMode="Password"></asp:TextBox>
&nbsp;&nbsp;
    <asp:Label ID="lbl_mensagem2" runat="server" ForeColor="Red"></asp:Label>
</p>
<p class="auto-style3">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<p class="auto-style3">
    &nbsp;&nbsp;&nbsp;
    <asp:Button ID="btn_novo" runat="server" BackColor="#996633" ForeColor="White" OnClick="btn_novo_Click" Text="Novo Resgistro" Width="226px" Height="34px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btn_senha" runat="server" BackColor="#FF9999" OnClick="btn_senha_Click" Text="Esqueceu Senha" />
</p>
